...
<body style="background-image:url('/image/clg.jpg');background-size: 100%">
  <header>
<div class="row" style="text-align:center;background-image:url('/image/j1.jpg');background-size: 100%">
...
<button type="button" class="btn btn-link" ><ul>Projects</ul></button>
