...
<img src="{{URL::asset('/image/servicesimg1.jpg')}}" style="height:350px;width:350px;padding:15px;float:right;">
	<p>
...
<h2 style="color:#7E94FF">For AGENTS</h2>
	<img src="{{URL::asset('/image/servicesimg2.jpg')}}" style="height:350px;width:350px;padding:15px;float:right">
	<p>
...
<h2 style="color:#7E94FF">For ALLOTTEES</h2>
	<p><img src="{{URL::asset('/image/servicesimg3.jpg')}}" style="height:350px;width:350px;padding:15px;float:right;">
...
<p><img src="{{URL::asset('/image/servicesimg4.jpg')}}" style="height:300px;width:400px;padding:15px;float:right;">
